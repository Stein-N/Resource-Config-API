...
public class DoubleValueEntry extends NumberValueEntry<Double> {
    ...
    public DoubleValueEntry(ResourceConfigScreen screen, String modId, String fileName, String key, Field field, Object defaultValue) {
        super(screen, modId, fileName, key, field, defaultValue, false,
