...
public class LongValueEntry extends NumberValueEntry<Long> {
    ...
    public LongValueEntry(ResourceConfigScreen screen, String modId, String fileName, String translationKey, Field field, Object defaultValue) {
        super(screen, modId, fileName, translationKey, field, defaultValue, true, Pattern.compile("[0-9]{0,15}"));
    }
